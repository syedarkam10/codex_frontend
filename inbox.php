    ...
    <div class="container">
         <div class="">
                <div class="breadcrumb">
                    <a href="user_account.php">Accounts</a> <span class="ar-right"><i class="ri-arrow-right-s-line"></i></span><a href="inbox.php">Messages</a>
                </div>
            ...
            <div class="col-md-9 col-12">
                <div class="tab-content px-2 px-md-4" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                        ...
                        <form class="mb-0">
                            <div class="col-md-12 bg-white msg-textarea">
                                <textarea class="form-control  border-0 msg-textarea" id="msg-send" rows="2" placeholder="Type a message" ></textarea>
                    ...
                    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                        ...
                        <form class="mb-0">
                            <div class="col-md-12 bg-white msg-textarea">
                                <textarea class="form-control  border-0 msg-textarea" id="msg-send" rows="2" placeholder="Type a message" placeholder="Type a message"></textarea>
                                <div class="mt-2 text-end me-3 pb-2">
                                    <a href="#">
                                        <button class="btn-msg-send">send</button>
                                    </a>
